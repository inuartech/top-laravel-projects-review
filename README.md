...
| [`outputs/index.html`](outputs/index.html) · [Live](https://inuartech.com/laravel-projects-reviewed/) | Interactive scorecard dashboard with rankings, scorecards, insights, contributor profiles |
